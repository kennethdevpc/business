...
export default function page() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-darkBg to-octonary text-white px-8 py-20 md:px-40">
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="rounded-2xl p-6 flex flex-col group relative">
              ...
              <ul className="space-y-4 mb-8">
                {['Flexible schedule', 'Beginner-friendly', 'Feel the joy of dancing!'].map(
                  (item, i) => (
            ...
            <div className="rounded-2xl p-6 flex flex-col group relative transform scale-105 z-10">
              ...
              <ul className="space-y-4 mb-8">
                {['Improve faster', 'Social & fun atmosphere', 'Learn at your own pace'].map(
                  (item, i) => (
                    <li key={i} className="flex items-start">
                      <span className="text-secondary mr-3 text-xl">✓</span>
                      <span className="group-hover:text-white transition-colors duration-300">
            ...
            <div className="rounded-2xl p-6 flex flex-col group relative">
              ...
              <ul className="space-y-4 mb-8">
                {['Deeper learning', 'Build confidence', 'Dance with freedom!'].map((item, i) => (
                  <li key={i} className="flex items-start">
                    <span className="text-secondary mr-3 text-xl">✓</span>
                    <span className="group-hover:text-white transition-colors duration-300">
                      {item}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* 1 Group Class */}
            <div className="rounded-2xl p-6 flex flex-col group relative hover:shadow-xl hover:shadow-secondary/10 transition-all duration-300 bg-gradient-to-br from-secondary/20 to-purple-600/20 ">
            ...
            {/* 1 Private Class */}
            <div className="rounded-2xl p-6 flex flex-col group relative hover:shadow-xl hover:shadow-secondary/10 transition-all duration-300 bg-gradient-to-br from-secondary/40 to-purple-600/40">
              {/* Card background with gradient border */}
              <div className="absolute inset-0.5 bg-gray-900 rounded-2xl -z-10"></div>
              ...
              <div className="mt-auto pt-6 border-t border-gray-700/50">
                ...
                <p className="text-sm text-gray-100">
                  <span className="">🗓️</span> Just schedule it, maximum 1 person 😊
                </p>
                <p className="text-sm text-gray-100 mt-1">
                  <span className="">🗓️</span> for 2 people €92 😊
                </p>
              </div>
